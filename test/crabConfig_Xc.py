...
datasetnames = [
'/Charmonium/Run2017B-PromptReco-v1/MINIAOD',
'/Charmonium/Run2017B-PromptReco-v2/MINIAOD',
'/Charmonium/Run2017C-PromptReco-v1/MINIAOD',
'/Charmonium/Run2017C-PromptReco-v2/MINIAOD',
'/Charmonium/Run2017C-PromptReco-v3/MINIAOD',
'/Charmonium/Run2017D-PromptReco-v1/MINIAOD',
'/Charmonium/Run2017E-PromptReco-v1/MINIAOD',
'/Charmonium/Run2017F-PromptReco-v1/MINIAOD'
]
...
config.General.workArea         = 'ChiC_v1'
...
config.Data.outLFNDirBase       = '/store/user/slezki/ChiC_v1'
